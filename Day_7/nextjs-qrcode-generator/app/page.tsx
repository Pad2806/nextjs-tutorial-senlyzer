...
export default function Home() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <Link
        href="/generate"
        className="block bg-white shadow-lg hover:shadow-xl transition rounded-2xl p-8 max-w-sm text-center border border-gray-200"
      >
        <h2 className="text-xl font-semibold text-gray-900">
          Generate QR Code →
        </h2>
        <p className="text-gray-500 mt-2">
          Create QR code from text or any URL instantly.
        </p>
      </Link>
    </div>
  );
